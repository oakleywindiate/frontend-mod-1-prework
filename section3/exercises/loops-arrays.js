...
var moreAnimals = ["whale", "snake", "turtle", "chicken"];
...
var shoppingList = ["chicken", "bread", "pumpkin", "rice"];
...
var doubleNumber = [3, 5, 7, 9, 11];

for (var i = 0; i < doubleNumber.length; i++) {
console.log(doubleNumber[i] * 2);
}

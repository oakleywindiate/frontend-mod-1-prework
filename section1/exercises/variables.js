...
// log that variable to the console.
var movieQuotes = "Harry Potter must not return to Hogwarts!";
...
/*
1. The variable "firstName" is a string data type because names are written with text. Text should be written

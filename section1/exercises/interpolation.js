...
var birdSpeciesName = "Passer domesticus";
var birdOrderName = "Passeriformes";
var birdCommonName = "House Sparrow";

console.log( `The bird species ${birdSpeciesName}, commonly known as the ${birdCommonName}, is in the order ${birdOrderName}.`);
